...
if __name__ == "__main__":
    ...
    test_split  = len(dataset) - train_split - val_split # pick up what's left over
    ...
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True) # is shuffling necessary?
