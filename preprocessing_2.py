...
def transform(monthly_data):
    ...
    # move transformed CPIAUCSL and UNRATE to the final two columns
    cpi_col = monthly_data.pop('CPIAUCSL')
    unrate_col = monthly_data.pop('UNRATE')
    monthly_data['CPIAUCSL'] = cpi_col
    monthly_data['UNRATE'] = unrate_col
...
if __name__ == "__main__":
    ...
    # data.to_csv('data/monthly_filled.csv', index=False)
